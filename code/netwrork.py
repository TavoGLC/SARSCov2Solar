...
file = '/media/tavo/storage/biologicalSequences/covidsr2/selected/fold_out_gene0.txt'
...
data = pd.read_csv('/media/tavo/storage/biologicalSequences/covidsr2/selected/string_interactions.tsv',sep='\t')
...
selectednodes = [k for k in range(730) if neighbours[k]>threshold]
...
ax.axis('off')
#plt.savefig('/media/tavo/storage/biologicalSequences/covidsr2/images/image_intr.png',dpi=75,bbox_inches='tight')
