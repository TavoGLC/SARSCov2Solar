...
reSamplingIndex = GetEqualizedIndex(MetaData['outbreakdays'],maxCount=175,bins=1017)
...
outdir = '/media/tavo/storage/biologicalSequences/covidsr2/FoldsBiased'
...
for k,fld in enumerate(folds.split(trainInx)):
    ...
    trainDF['Fold'+str(k)] = trainInx[train_index][0:115079]
    testDF['Fold'+str(k)] = trainInx[test_index][0:28769]
