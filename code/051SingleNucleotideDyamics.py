...
KmerData = pd.read_csv('/media/tavo/storage/biologicalSequences/covidsr04/sequences/KmerDataUpd2023.csv',usecols=['id']+Alphabet)
...
labels = ['date','dayofyear','sunspots']
...
plt.tight_layout()
plt.savefig('/media/tavo/storage/biologicalSequences/covidsr04/data/images/image_dyn.png',dpi=75,bbox_inches='tight')
plt.close()