...
dataPath = '/media/tavo/storage/biologicalSequences/covid/datasets/Relational'
...
basePath = '/media/tavo/storage/biologicalSequences/covidsr2/Models/Relational'
...
for val in wlnames:
    ...
    data[val] = [sal if np.abs((sal-mean)/std)<4 else mean for sal in data[val]]
