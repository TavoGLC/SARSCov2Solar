...
file = '/media/tavo/storage/biologicalSequences/covidsr04/data/selected/fold_out_4.txt'
transcriptsdir = '/media/tavo/storage/biologicalSequences/covidsr04/data/selected/'
...
outfile1 = '/media/tavo/storage/biologicalSequences/covidsr04/data/selected/fold_out_names.txt'
...
outfile2 = '/media/tavo/storage/biologicalSequences/covidsr04/data/selected/fold_out_gene.txt'
...
PlotStyle(axs2)
plt.tight_layout()
plt.savefig('/media/tavo/storage/biologicalSequences/covidsr04/data/images/image_dm.png',dpi=75,bbox_inches='tight')
